...
- public Ruby APIs such as `test`, `use_fixture`, `fixture`, `suite_fixture`, `on_teardown`, and `expect`
- matcher behavior
- CLI arguments, default globs, output, and exit status
- fixture resolution, caching, teardown, duplicate fixture detection, and circular dependency detection
